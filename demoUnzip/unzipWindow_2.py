...
# Form implementation generated from reading ui file 'unzipWindow_2.ui'
#
...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.pushButton_Unzip.setGeometry(QtCore.QRect(410, 210, 141, 71))
        self.pushButton_Unzip.setObjectName("pushButton_Unzip")
        self.pushButton_Open = QtWidgets.QPushButton(Dialog)
        self.pushButton_Open.setGeometry(QtCore.QRect(60, 210, 141, 71))
        self.pushButton_Open.setObjectName("pushButton_Open")
        self.pushButton_Extract = QtWidgets.QPushButton(Dialog)
        self.pushButton_Extract.setGeometry(QtCore.QRect(240, 210, 141, 71))
    ...
    def retranslateUi(self, Dialog):
        ...
        self.pushButton_Extract.setText(_translate("Dialog", "SetExtractPath"))

...
# Form implementation generated from reading ui file 'software1.ui'
#
...
class Ui_Dialog(object):
    def setupUi(self, MainWindow):
        ...
        self.treeView.setGeometry(QtCore.QRect(310, 90, 256, 241))
        self.treeView.setObjectName("treeView")
        self.treeView_2 = QtWidgets.QTreeView(self.centralwidget)
        self.treeView_2.setGeometry(QtCore.QRect(590, 90, 256, 241))
        self.treeView_2.setObjectName("treeView_2")
        MainWindow.setCentralWidget(self.centralwidget)
        self.menubar = QtWidgets.QMenuBar(MainWindow)
        self.menubar.setGeometry(QtCore.QRect(0, 0, 1262, 23))
